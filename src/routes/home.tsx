...
export const HomePage: FC<{ me: Identity; boards: Board[]; hots: HotItem[]; stats: Array<[string, string]>; tracks: Array<[string, string]>; level: LevelInfo; unread?: number; byeNotice?: string }> = ({
  me, boards, hots, stats, tracks, level, unread, byeNotice,
}) => (
  <Layout title="首页" activeNav="全部版块" me={me} unread={unread}>
    <p class="crumb">空山 › 版块广场</p>
    {byeNotice && <div class="notice-warm" role="status"><span>{byeNotice}</span></div>}
    <div class="home-grid">
      {/* 左栏 */}
