...
export const NewThreadPage: FC<{ me: Identity; boards: Board[]; error?: string; notice?: string; captcha?: { id: string; prompt: string } }> = ({ me, boards, error, notice, captcha }) => (
  <Layout title="发新洞" me={me}>
